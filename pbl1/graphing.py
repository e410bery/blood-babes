...
color = mypink
ax1.set_xlabel('Time (day)')
ax1.set_ylabel('Estrogen (pg/mL)', fontweight='bold', fontsize='large', color=color)
...
ax2 = ax1.twinx()  
color = myblue
ax2.set_ylabel('Progesterone (ng/mL)', color=myblue, fontweight='bold', size='large')  
...
ax2.plot(e.time, e.hep, color=mypink)
ax2.set_xticks(range(0, 7))
ax2.tick_params(axis='y', labelcolor='black')
ax2.set_xticklabels(['0', '1', '2', '3', '4', '5', '6'])
fig.tight_layout()
plt.savefig("EstHepIron.png", bbox_inches="tight")
plt.close()
